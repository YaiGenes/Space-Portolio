...
const expEN: ExperienceEntry[] = [
  {
    ...
    location: "Remote",
    highlights: [
      "Reduced merge-peer compute costs by 25.9% fleet-wide via Vertical Pod Autoscaler rollout across 200+ production clusters — cost per TB dropped from CHF 645 to CHF 479, with one cluster cutting node count by 74%, saving an estimated CHF 132K–263K/year",
...
const expDE: ExperienceEntry[] = [
  {
    ...
    location: "Remote",
    highlights: [
      "Merge-Peer-Compute-Kosten fleet-weit um 25,9 % reduziert durch Rollout des Vertical Pod Autoscaler auf 200+ Produktions-Cluster — Kosten pro TB von CHF 645 auf CHF 479 gesunken; ein Cluster reduzierte die Node-Anzahl um 74 % und spart geschätzte CHF 132K–263K/Jahr",
...
const expFR: ExperienceEntry[] = [
  {
    ...
    highlights: [
      "Réduction des coûts de calcul merge-peer de 25,9 % sur l'ensemble de la flotte via le déploiement du VPA sur 200+ clusters de production — coût par To passé de CHF 645 à CHF 479 ; un cluster a réduit son nombre de nœuds de 74 %, économisant CHF 132K–263K/an",
